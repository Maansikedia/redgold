...
function Donate() {
    ...
    useEffect(() => {
        ...
        fetch('https://redgold1.herokuapp.com/api/appointment/all', {
            method: "get",
            headers: {
    ...
    const deleteAppointment = (appointmentId) => {
        ...
        fetch(`https://redgold1.herokuapp.com/api/appointment/delete/${appointmentId}`, fetchData)
        .then(res => res.json())
        .then(data2 => {
            if(data2.error) {
    ...
    const donateBlood = () => {
        ...
        fetch('https://redgold1.herokuapp.com/api/appointment/new', fetchData)
        .then(res => res.json())
        .then(data2 => {
            if(data2.error) {
                toast.error(data2.error)
