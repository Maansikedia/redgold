...
function BloodBank() {
    ...
    useEffect(() => {
        ...
        fetch('https://redgold1.herokuapp.com/api/blood/all', {
            method: "get",
            headers: {
    ...
    const addBloodGroup = (e) => {
        ...
        fetch('https://redgold1.herokuapp.com/api/blood/add', fetchData)
        .then(res => res.json())
        .then(data2 => {
            setLoading(false);
            if(data2.error) {
    ...
    const bookBlood = (bloodId) => {
        ...
        fetch('https://redgold1.herokuapp.com/api/booking/new', {
            method: "post",
            headers: {
                "Content-Type": "application/json",
                "Authorization":"Bearer "+JSON.parse(localStorage.getItem("jwt"))
    ...
    const deleteBlood = (bloodId) => {
        ...
        fetch(`https://redgold1.herokuapp.com/api/blood/delete/${bloodId}`, fetchData)
        .then(res => res.json())
        .then(data2 => {
            if(data2.error) {
                toast.error(data2.error)
