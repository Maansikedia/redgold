...
function Register() {
    ...
    const registerHelper = (e) => {
        ...
        fetch('https://redgold1.herokuapp.com/api/auth/register', fetchData)
        .then(res => res.json())
        .then(data2 => {
            setLoading(false);
            if(data2.error) {
                        ...
                        <>
                            ...
                            <form onSubmit={(e) => registerHelper(e)}>
                                <div className="form-group">
                                    <input type="text" className="form-control" id="name" aria-describedby="nameHelp" autoFocus placeholder="Name (e.g. Maansi Kedia)" onChange={(e) => setName(e.target.value)} required />
                                </div>
                                <br />
                                <div className="form-group">
                                    <input type="text" className="form-control" id="phone" aria-describedby="phoneHelp" placeholder="Phone (e.g. +91-8529XXXXXX)" onChange={(e) => setPhone(e.target.value)} required />
                                </div>
                                <br />
                                <div className="form-group">
